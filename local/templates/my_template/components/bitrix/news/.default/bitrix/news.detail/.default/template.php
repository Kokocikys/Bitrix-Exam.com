...
<div class="news-detail">
    ...
    <div class="complaintButton">
        <button class="complaints" data-news-id="<?= $arResult["ID"]; ?>"
                data-iblock-type-id="<?= $arResult["IBLOCK_TYPE_ID"]; ?>">Пожаловаться на новость</button>
        <div class="complaintsMessage"></div>
    </div>
</div>