...
$arDefaultUrlTemplates404 = array(
    ...
    "exampage" => "exampage/new/#PARAM1#/?PARAM2=#PARAM2#",
);
...
if ($arParams["SEF_MODE"] == "Y") {
    ...
    if ($componentPage == "section" && isset($arVariables["SECTION_ID"]) && intval($arVariables["SECTION_ID"]) . "" !== $arVariables["SECTION_ID"]) {
        $b404 = true;
    }
    ...
    elseif (isset($arVariables["SECTION_CODE"]) && strlen($arVariables["SECTION_CODE"]) > 0)
        $componentPage = "section";
    elseif (isset($arVariables["PARAM1"]) && strlen($arVariables["PARAM1"]) > 0 && isset($arVariables["PARAM2"]) && strlen($arVariables["PARAM2"]) > 0)
